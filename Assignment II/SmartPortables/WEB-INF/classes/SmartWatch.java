...
/* 
	SmartWatch class contains class variables name,price,image,retailer,condition,discount.

	SmartWatch class constructor with Arguments name,price,image,retailer,condition,discount.
...
public class SmartWatch extends HttpServlet
{
	...
	public SmartWatch(String name, double price, String image, String retailer,String condition,double discount,String rebate,
